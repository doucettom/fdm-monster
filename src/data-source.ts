...
import { UserPropertyDefaultsAndIsVerified1697275970026 } from "@/migrations/1697275970026-UserPropertyDefaultsAndIsVerified";
import { UserCreatedAtDate1698089467125 } from "@/migrations/1698089467125-UserCreatedAtDate";
import { PrintCompletion1699089948099 } from "@/migrations/1699089948099-PrintCompletion";
import { RefreshTokenOnDeleteCascade1699090147205 } from "@/migrations/1699090147205-RefreshTokenOnDeleteCascade";
import { ChangePrintCompletionSetNullPrinterDelete1699093310146 } from "@/migrations/1699093310146-ChangePrintCompletionSetNullPrinterDelete";
import { UserRole } from "@/entities/user-role.entity";
import { UserRoleConstrained1699176840316 } from "@/migrations/1699176840316-UserRoleConstrained";
import { PrintCompletionCorrelationId1699189686327 } from "@/migrations/1699189686327-PrintCompletionCorrelationId";
...
export const AppDataSource = new DataSource({
  ...
  migrations: [
    ...
    UserPropertyDefaultsAndIsVerified1697275970026,
    UserCreatedAtDate1698089467125,
    PrintCompletion1699089948099,
    RefreshTokenOnDeleteCascade1699090147205,
    ChangePrintCompletionSetNullPrinterDelete1699093310146,
    UserRoleConstrained1699176840316,
    PrintCompletionCorrelationId1699189686327,
